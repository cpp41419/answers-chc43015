...
export const questions: FAQQuestion[] = [
  ...
  // High-Value SEO Questions
  {
    id: generateId(),
    question: "Is CPP41419 recognized in all Australian states?",
    answer: "Yes, CPP41419 is a nationally recognized qualification under the Australian Qualifications Framework (AQF). However, each state has its own licensing requirements and application processes. While the qualification is accepted nationwide, you must apply for a license in the specific state where you want to work. Some states may have additional requirements such as probationary periods or state-specific training modules.",
    category: "Course Basics & Enrollment",
    keywords: ["national recognition", "state licensing", "AQF", "interstate recognition"],
    provider_specific: false,
    priority: 1,
    last_updated: defaultLastUpdated,
    averageRating: undefined,
  ...
  {
    id: generateId(),
    question: "Can I study CPP41419 online or do I need classroom attendance?",
    answer: "CPP41419 can be completed entirely online through most RTOs, with no mandatory classroom attendance required. Online delivery includes interactive modules, video content, virtual simulations, and online assessments. Some providers offer blended learning options combining online study with optional face-to-face workshops. Practical skills are typically assessed through case studies and role-playing scenarios rather than in-person demonstrations.",
    category: "Study Options & Duration",
    keywords: ["online study", "classroom attendance", "blended learning", "distance education"],
    provider_specific: false,
    priority: 1,
    last_updated: defaultLastUpdated,
    averageRating: undefined,
  ...
  {
    id: generateId(),
    question: "What is the pass rate for CPP41419 assessments?",
    answer: "Pass rates for CPP41419 vary by RTO but typically range from 85-95% for students who complete all required activities. The qualification uses competency-based assessment, meaning you're marked as 'competent' or 'not yet competent' rather than receiving grades. Students who don't pass initially can resubmit assessments after receiving feedback. Most RTOs provide multiple opportunities to demonstrate competency and offer additional support for struggling students.",
    category: "Assessment & Completion",
    keywords: ["pass rate", "competency assessment", "resubmission", "success rate"],
    provider_specific: false,
    priority: 1,
    last_updated: defaultLastUpdated,
    averageRating: undefined,
  ...
  {
    id: generateId(),
    question: "Do I need work experience before starting CPP41419?",
    answer: "No prior work experience in real estate is required to enroll in CPP41419. The course is designed for complete beginners and covers all fundamental knowledge from scratch. However, any customer service, sales, or property-related experience can be beneficial and may help you progress faster through the material. Some RTOs offer Recognition of Prior Learning (RPL) assessments if you have relevant experience.",
    category: "Course Basics & Enrollment",
    keywords: ["work experience", "prerequisites", "beginners", "entry requirements"],
    provider_specific: false,
    priority: 1,
    last_updated: defaultLastUpdated,
    averageRating: undefined,
  ...
  {
    id: generateId(),
    question: "Can I get RPL (Recognition of Prior Learning) for CPP41419?",
    answer: "Yes, you can apply for RPL if you have relevant experience in real estate, property management, sales, or related fields. RPL allows you to receive credit for units where you can demonstrate existing competency, potentially reducing study time and costs. You'll need to provide evidence such as employment records, references, work samples, and may need to complete skills assessments. RPL is assessed individually by each RTO and typically covers 30-70% of the qualification depending on your background.",
    category: "Assessment & Completion",
    keywords: ["RPL", "recognition prior learning", "work experience", "credit transfer", "reduced study time"],
    provider_specific: false,
    priority: 1,
    last_updated: defaultLastUpdated,
    averageRating: undefined,
